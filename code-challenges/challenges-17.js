...
const recursionPattern = (int1, int2) => {
    if (int1==numbersArr[0]) {
        numbersArr.push(int1);
        return numbersArr
    }
    numbersArr.push(int1);
    if (numbersArr.some(v => v < 0)) {
        //console.log(int1)
...
const filterLinks = (str) => {
    ...
    //const splitted2=splitted1.split("/")
    let ahmad=splitted1[1].slice(7)
...
const isPalindrome = (str) => {
    ...
    let empty=lowerCase.replace(/\W/g,"");
